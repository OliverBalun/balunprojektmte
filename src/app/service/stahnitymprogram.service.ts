...
export class StahnitymprogramService {

  //url ='https://www.thesportsdb.com/api/v1/json/1/all_leagues.php';
  url = 'https://www.thesportsdb.com/api/v1/json/1/eventsnext.php?id=';//'https://www.thesportsdb.com/api/v1/json/1/eventsnext.php?id=133602';
  ...
  public getTymprogram(teamID:string){
    //let headers = new HttpHeaders();
   // headers = headers.set('X-RapidAPI-Key', this.apiKey);
    //headers.append('X-RapidAPI-Host', this.apiHost);
    //console.log(headers);
    return this.http.get(this.url+teamID);//.map((res: Response) => res.json())
    //let url = url;
